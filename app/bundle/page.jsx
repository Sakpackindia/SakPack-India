...
export const metadata = { title: "Build Your Own Bundle - Sakpack India" };
...
export default async function BundlePage() {
  ...
  return (
    <>
      <SiteHeader />
      <main className="relative overflow-hidden pb-24 bg-[#3d0d20] text-ivory">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-wrap px-6 py-10 sm:py-14 md:px-12">
            ...
            {settings.subtitle && <p className="mt-3 max-w-xl text-lg sm:text-lg text-ivory/60 font-semibold">{settings.subtitle}</p>}
            {settings.fixed_price != null && (
              <span className="mt-5 inline-flex items-center gap-2 rounded-full border border-gold-400/25 bg-gold-400/5 px-4 py-1.5 text-base font-semibold uppercase tracking-[0.2em] text-gold-200">
