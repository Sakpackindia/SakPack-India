    ...
    >
      ...
      <div className="text-center">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-gold-400/35 bg-gold-400/15 px-4 py-1 text-base font-black uppercase tracking-[0.2em] text-gold-700">
          <Sparkles className="h-3.5 w-3.5 text-gold-600 animate-pulse" /> Join Sakpack
        </span>
        ...
        <p className="mt-2 text-base text-ink/70 font-medium">Faster checkout and order tracking, every visit.</p>
      </div>
      ...
      <form action={formAction} className="relative mt-6 space-y-4">
        ...
        <div className="relative group">
          <User className="absolute left-4 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-gold-600/80 group-focus-within:text-gold-600 transition-colors duration-300" />
        ...
        {/* Phone Input */}
        <div className="relative group">
          <Phone className="absolute left-4 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-gold-600/80 group-focus-within:text-gold-600 transition-colors duration-300" />
        ...
        >
          {pending ? (
            ...
            <span className="inline-flex items-center gap-2">
              <UserPlus className="h-4 w-4 text-gold-300" />
              Create Account
            </span>
          )}
        </motion.button>
