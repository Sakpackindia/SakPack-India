    ...
    <tr className="group/row transition-colors duration-300 hover:bg-ink/[0.03]">
      <td className="py-4 pr-4 pl-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-ink group-hover/row:text-gold-700 transition-colors duration-300">
            {product.name}
          </span>
        </div>
      </td>
      <td className="py-4 pr-4 text-xs font-semibold text-ink/60">{product.categoryName || "—"}</td>
      <td className="py-4 pr-4 text-sm font-semibold text-ink/80">
