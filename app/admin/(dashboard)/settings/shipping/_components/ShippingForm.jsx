  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-display text-lg font-semibold text-ink">Delivery Rates</h2>
      </div>
      ...
      <div>
        ...
        <p className="mt-1.5 text-base font-semibold text-ink/30">Orders above this amount ship for free.</p>
      </div>
      <div>
