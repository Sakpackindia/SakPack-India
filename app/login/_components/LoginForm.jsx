    ...
    >
      ...
      <div className="text-center">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-gold-400/35 bg-gold-400/15 px-3.5 sm:px-4 py-1 text-xs font-black uppercase tracking-[0.18em] sm:tracking-[0.2em] text-gold-700">
          <Sparkles className="h-3.5 w-3.5 text-gold-600 animate-pulse shrink-0" /> Welcome Back
        </span>
        ...
        <p className="mt-2 text-sm sm:text-base text-ink/75 font-medium leading-relaxed">Track orders, save favorites, and checkout faster.</p>
      </div>
      ...
      <form action={formAction} className="relative mt-6 space-y-4">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-xs sm:text-sm text-gold-700 hover:text-gold-600 font-extrabold uppercase tracking-wider transition-colors duration-300"
          >
            Forgot password?
          </Link>
        </div>
        ...
        >
          {pending ? (
            ...
            <span className="inline-flex items-center gap-2">
              <LogIn className="h-4 w-4 text-gold-300 shrink-0" fill="currentColor" />
              Log In to Account
            </span>
          )}
        </motion.button>
