      ...
      <Reveal>
        <div className="group relative overflow-hidden rounded-[2rem] border border-gold-400/20 bg-ink-gradient px-6 py-14 text-center shadow-2xl transition-all duration-500 hover:border-gold-400/35 hover:shadow-[0_20px_50px_-24px_rgba(202,161,75,0.25)] sm:rounded-[2.5rem] sm:px-8 sm:py-20 md:px-16">
          ...
          <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center">
            <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-gold-400/20 bg-ink-soft/80 px-4 py-1.5 text-base font-semibold uppercase tracking-[0.25em] text-gold-200 backdrop-blur-md">
            ...
            <p className="mb-8 max-w-lg text-base font-light leading-relaxed text-ivory/60 sm:mb-10 sm:text-lg lg:text-xl">
              Just tell us your size and what you're looking for, and we&rsquo;ll help you pick the right piece.
            </p>

            <div className="flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row sm:gap-4">
              <a
                href={whatsappLink("Hi Sakpack India, can you help me find the right size/fit? I usually wear...")}
                target="_blank"
                rel="noopener noreferrer"
                className="btn-gold flex w-full items-center justify-center gap-2 px-6 py-3.5 text-base font-medium transition-transform hover:scale-[1.02] sm:w-auto sm:px-8 sm:py-4"
              >
                <MessageSquare className="h-4 w-4 text-ink" /> Chat on WhatsApp
              </a>
              <Link
                href="/shop"
                className="btn-outline group/link flex w-full items-center justify-center gap-2 px-6 py-3.5 text-base font-medium transition-all hover:bg-gold-400/5 sm:w-auto sm:px-8 sm:py-4"
              >
