...
export default function LimitedEdition({
  subtitle = "Fresh styles, added often. Handpicked fabrics and everyday essentials made for real comfort.",
  headingLine1 = "Fresh Styles,",
  headingLine2 = "Just For You",
  buttonText = "Explore New Arrivals",
  image = "/bra-white-triview.png",
  showImage = true,
}) {
  return (
    <section className="relative w-full overflow-hidden border-t border-ink-line bg-[#3d0d20] py-16 sm:py-24">
      {/* Ambient glows */}
      ...
      <div className="relative mx-auto max-w-wrap px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {showImage && (
            <div className="lg:col-span-6 relative flex flex-col items-center justify-center min-h-[340px] sm:min-h-[440px]">
              ...
              <div className="relative z-10 aspect-square w-full">
                <Image
                  src={image}
                  alt="Sakpack India new arrivals"
                  fill
          ...
          <div className={`flex flex-col justify-center ${showImage ? "lg:col-span-6" : "lg:col-span-12 items-center text-center"}`}>
            <Reveal>
              <p className="eyebrow">
                <span className="gold-line" /> New Arrivals
              </p>
              ...
              <p className="mb-8 max-w-md text-lg font-light leading-relaxed text-ivory/60 sm:text-lg lg:text-xl">
                {subtitle}
              </p>

              <Link
                href="/shop"
                className="btn-gold w-fit px-8 py-4 text-base font-medium transition-transform hover:scale-[1.02]"
              >
                {buttonText}
              </Link>
            </Reveal>
